<x-sidebar-layout :title="'Tambah CPL'" :header="'Tambah CPL'">
    <div class="obe-card">
        <form method="POST" action="{{ route('cpls.store') }}">
            @csrf
            <div class="mb-3">
                <label class="form-label fw-semibold">Kode CPL <span class="text-danger">*</span></label>
                <input type="text" name="code" value="{{ old('code') }}" required placeholder="Contoh: CPL 01" autocomplete="off"
            ...
            <div class="mb-3">
                ...
                <div class="input-group" style="max-width: 200px;">
                    <input type="number" name="min_target" value="{{ old('min_target', 60) }}"
