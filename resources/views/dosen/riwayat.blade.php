<x-sidebar-layout :title="'Riwayat Kelas'" :header="'Riwayat Kelas'">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-3 gap-2">
        <p class="text-muted small mb-0">
            Daftar kelas yang sudah diarsipkan dan pernah Anda ampu.
        </p>
    </div>

    @if($classrooms->isEmpty())
        <div class="alert alert-warning">
            Belum ada kelas arsip yang tercatat untuk Anda.
        </div>
    @else
                    ...
                    <tbody>
                        @foreach($classrooms as $i => $c)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-light text-dark border">{{ ucfirst($c->period_type ?? '-') }} {{ $c->academic_year }}</span>
                                </td>
                                <td class="text-center">
