<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">Daftar CPL</h2>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex justify-end mb-4">
                        <a href="{{ route('cpls.create') }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded flex items-center">
                            <span class="mr-2">+</span> Tambah CPL
                        </a>
                    </div>
                            ...
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-center text-xs font-bold uppercase tracking-wider border-r border-gray-600">
                                        Pernyataan Capaian Pembelajaran Lulusan
                                    </th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-medium">
                                        <div class="flex justify-center space-x-2">
                                            <a href="{{ route('cpls.edit', $cpl) }}" class="text-blue-600 hover:text-blue-900" title="Edit">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                            </a>
                                            <form action="{{ route('cpls.destroy', $cpl) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus CPL ini?');" class="inline">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-8 text-center text-gray-500">
                                        Belum ada data CPL. Klik "Tambah CPL" untuk menambahkan.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
